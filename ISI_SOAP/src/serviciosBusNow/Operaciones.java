...
public class Operaciones {
	 ...
	 */
	public static ArrayList<String> obtenerBusesDisponibles(String busAtascado) {
	 ...
	 * @return
	 */
	public static ArrayList<String> obtenerBusesNoAparcados(String busAparcado) {
